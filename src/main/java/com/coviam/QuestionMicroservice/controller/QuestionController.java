...
public class QuestionController {
    ...
    public ResponseEntity<List<QuestionDTO>> getProductDetailsById(@RequestBody List<String> questionId) {
        List<QuestionEntity> questionEntityList = questionService.getAllById((questionId));
